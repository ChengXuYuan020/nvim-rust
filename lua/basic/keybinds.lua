...
vim.keybinds.gmap("n", "<C-u>", "12k", vim.keybinds.opts)
vim.keybinds.gmap("n", "<C-d>", "12j", vim.keybinds.opts)
-- 插入模式下的上下左右移动
...
vim.keybinds.gmap("n", "<leader>3", "<cmd>RustHoverActions<CR>", vim.keybinds.opts)
